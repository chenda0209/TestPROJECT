    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            v2f vert (appdata v)
            {
                ...
                float angleX = stretch * _WaveSpeed_X * 1.5708;
                float angleZ = stretch * _WaveSpeed_Y * 1.5708;
            ...
            half4 frag (v2f i , bool isFace : SV_IsFrontFace) : SV_Target
            {
                ...
                return half4(brdf * lambert * light.shadowAttenuation * i.positionOS.y + GI * col.rgb * _Color.rgb, 1);
            }
            ENDHLSL
        }
